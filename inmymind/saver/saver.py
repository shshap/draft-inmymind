...
from inmymind.saver._saver_utils import find_getter
...
"""
"""
In readme, write "readme for users" and then "readme for developers".
The above comment will be in the second one
"""
"""
...
def run_saver(raw_getter_url, raw_handler_url):
    get_method = find_getter(raw_getter_url)
    logger.debug('start serving')
    get_method(raw_getter_url, raw_handler_url)
...
if __name__ == '__main__':
    run_saver('rabbitmq://guest:guest@localhost:127.0.0.1',
              'http://localhost:5000')
